...
use Webkul\DataFaker\Database\Seeders\CustomerAddressTableDataSeeder;
use Webkul\DataFaker\Database\Seeders\ProductCategoryTableDataSeeder;
            ...
            if($count > 0) {
                ...
                switch($input) {
                    case 1:
                        ...
                        $customerSeeder = new CustomerAddressTableDataSeeder;
                        $customerSeeder->callWith(CustomerAddressTableDataSeeder::class, [$count]);
                    ...
                    case 3:
                        ...
                        if($parent > 0 && $child > 0) {
                            ...
                            $categorySeeder = new ProductCategoryTableDataSeeder();

                            $categorySeeder->callWith(ProductCategoryTableDataSeeder::class, [$parent, $child,$this->faker]);
